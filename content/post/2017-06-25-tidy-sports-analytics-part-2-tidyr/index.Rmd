...
Before we start using the **tidyr** package, let's calculate whether each play was a success or not using the processes from the [previous post](/post/2017-06-09-tidy-sports-analytics-part-1-dplyr/).
