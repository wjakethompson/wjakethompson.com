...
After four very long years, the `r emo::ji("orange")` presidency finally comes to a close today as Joe Biden and Kamala Harris are inagurated as the President and Vice President. To celebrate, I thought I'd look back at the many election forecasts we had in 2020 to see which forecast performed the best, given the results we now have. To do this, we'll look at two outcomes: prediction accuracy and model accuracy. But first, the data!
...
![Brier penalties for Economist and FiveThirtyEight forecasts](index_files/figure-html/brier-compare-1.png){width=80%}
...
![Expected electoral votes for each forecast](index_files/figure-html/ec-expected-1.png){width=80%}
